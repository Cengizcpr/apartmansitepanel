  ...
  render() {
    return (
      ...
      <div className="content-wrapper">
        ...
        <div className="content-header"> 
         <div className="row">
    <div className="col-lg-3 col-6">{this.state.showMe? 
    <aside className="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <Link to='/home'  className="brand-link">
          ...
          <span className="brand-text font-weight-light">Apartman Site Panel</span>
        </Link>
        ...
        <div className="sidebar">
          ...
          <div className="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div className="info">
              <Link to='/adminprofile' className="d-block">Admin</Link>
            </div>
          </div>
      ...
      {this.state.showUser? 
       ...
       <div className="sidebar">
         ...
         <div className="user-panel mt-3 pb-3 mb-3 d-flex">
           ...
           <div className="info">
             <Link to='/adminprofile' className="d-block">Kullanıcı</Link>
           </div>
         </div>
