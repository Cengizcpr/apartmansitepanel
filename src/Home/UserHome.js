          ...
          if (response.request.response == "true") {
            axios.put("users/newpassword", updatePassword).then((response) => {
              if (response.request.response == "true") {
                ...
                setTimeout(function(){  window.location.replace("/userhome")}.bind(this),1000)
                      ...
                      <div className="col-md-12">
                        <div className="card card-dark">
                          <div className="card-header">
                            <h3 className="card-title">Hoşgeldin Sayın {this.state.first_name} {this.state.last_name}</h3>
                          </div>
                          <div className="card-body">
